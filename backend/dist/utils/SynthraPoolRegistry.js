...
exports.synthraV3Pools = exports.SYNTHRA_UNIVERSAL_ROUTER = void 0;
exports.getSynthraPoolForPair = getSynthraPoolForPair;
exports.getAllSynthraPoolAddresses = getAllSynthraPoolAddresses;
exports.hasSynthraPool = hasSynthraPool;
exports.getTokenAddress = getTokenAddress;
exports.getSynthraTokens = getSynthraTokens;
// Synthra UniversalRouter address (all swaps route through this)
exports.SYNTHRA_UNIVERSAL_ROUTER = '0xbf4479c07dc6fdc6daa764a0cca06969e894275f';
...
function getSynthraPoolForPair(token0, token1) {
    ...
    if (substituted0 !== normalized0 || substituted1 !== normalized1) {
        for (const [, pool] of Object.entries(exports.synthraV3Pools)) {
            ...
            if ((substituted0 === poolToken0 && substituted1 === poolToken1) ||
 ...
 */
function getAllSynthraPoolAddresses() {
    return Object.values(exports.synthraV3Pools).map((pool) => pool.poolAddress);
}
/**
 * Check if Synthra has a pool for the token pair
 */
function hasSynthraPool(token0, token1) {
 ...
 */
function getSynthraTokens() {
    return Object.values(TOKEN_ADDRESSES);
}
//# sourceMappingURL=SynthraPoolRegistry.js.map